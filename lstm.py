...
def main():
    ...
    model = LSTM(n_emb,vocab_size, hidden_size, context_length,return_sequences = False)
    input_sequence = torch.randint(1 , vocab_size , (1 , 20))
    print(input_sequence)
    output , (hidden, cell_state) = model(input_sequence)
    print(output.shape)
...
# Loading the tokenizer
    ...
    torch.save(model.state_dict(), 'lstm_language_model_urdu.pth')
